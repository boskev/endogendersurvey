...
#### Question 3:  Since Traiing Score was insignificant (almost identical results for each sex), was it too broad?  What happens if we focus on quesetions that had more to do with "equipment ergonomics/availability," since something has to be driving the sex differences observed in the Pain/Injury score:
...
<<<<<<< HEAD
  select( RECORD_ID, BIRTHSEX, BIRTHSEX2, AGE2, RACE, RACE2, TRAINING_LEVEL, starts_with("TRNG_"), starts_with("EQUIP_") )
=======
  select( RECORD_ID, BIRTHSEX, BIRTHSEX2, RACE, RACE2, TRAINING_LEVEL, starts_with("TRNG_"), starts_with("EQUIP_") )
>>>>>>> 29baa1738013ea2202e8643cafb138aa728e79f1
...
TRAINING %>% 
  group_by(BIRTHSEX) %>% 
  summarize( EQUIP = mean(EQUIP_SCORE),
             TRNGSD = sd(EQUIP_SCORE))
...
<<<<<<< HEAD
pairs.panels(SCORES[-c(1:3)], pch=21, stars=T,) #CORRELATION MATRIX
=======
pairs.panels(SCORES[-c(1:2)], pch=21, stars=T,) #CORRELATION MATRIX
>>>>>>> 29baa1738013ea2202e8643cafb138aa728e79f1
