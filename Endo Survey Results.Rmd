...
- This solution is very similar to the one above, except that included two questions that were originally excluded due to their perceived limited scope (questions regarding whether trainees were more or less likely to use Dial Extenders in front of a male or female instructor, as not all trainees need dial extenders).  By limiting the factor solution to nine, however, the "Respect" and "Training Confidence" factors were "reunited" to form one solid, reliable factor (as we saw in the Varimax-rotated solutions).
