...
- This solution is very similar to the one above, except that included two questions that were originally excluded due to their perceived limited scope (i.e., questions regarding whether trainees were more or less likely to use Dial Extenders in front of a male or female instructor, as 70% of trainees reported not even using Dial Extenders).  And with the addition of these two new questions, by holiding the number of factors requested at nine factors, we noticed that the "Respect" and "Trainee Confidence" factors were "reunited" to form one solid, reliable factor (identical to what was observed in the previously discussed Varimax-rotated solutions).  It should be noted that the scoring of these questions included *all* subjects, not just those reporting having used Dial Extended -- so *every* respondent contributed in some way to the factor scores and loadings of these two questions.
...
- Another way of looking at this:  Code Switchers are "people pleasers" who are not inclined to "rock the boat," and according to the correlation matrix above, they do not appear to command respect from ES Staff, do not perceive nurses as cooperative, are not vocal about ill-fitting lightweight or standard issue aprons, do not feel that they are trained with sensitivity/feedback (possibly because they do not insist on it), and as a result, have high correlation with reported incidences of transient pain and injury.
