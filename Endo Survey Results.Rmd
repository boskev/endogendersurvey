...
- If we were to use the resulting odds ratios to inform the profile of these so-called "Code Switchers," we might find that the . . . .
    ...
    - The odds ratio for them being either a First- or Second-Year trainee is 2.71 (insignificant result despite significant p-value - confint includes 1)
    ...
    - The odds ratio for them finding that nurses are not cooperative is 1.93 (insignificant results despite signficant p-value - confint includes 1)
