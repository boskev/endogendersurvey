...
- This solution is very similar to the one above, except that included two questions that were originally excluded due to their perceived limited scope (questions regarding whether trainees were more or less likely to use Dial Extenders in front of a male or female instructor, as not all trainees need dial extenders).  By limiting the factor solution to nine, however, the "Respect" and "Trainee Confidence" factors were "reunited" to form one solid, reliable factor (as we saw in the Varimax-rotated solutions).
- However, by including this question - and, more important, *all* subjects, even those who do not require Dial Extenders, we may have stumbled upon a factor that can be best described as `"Code Switching."`  While typically used in the context of cultural linguistics, "Code Switching" here is meant to imply that some trainees may act one way in front of one audience (i.e., "their people") and another way in front of perceived figures of authority (or simply in front of instructors who are different from them).
- Another way of looking at this:  Code Switchers are "people pleasers," and according to the correlation matrix above, they do not command respect from ES Staff, do not perceive nurses as cooperative, are not vocal about ill-fitting lightweight or standard issue aprons, do not feel that they are trained with sensitivity/feedback (possibly because they do not insist on it), and as a result, have high correlation with reported incidences of transient pain and injury.
