...
- If we were to use the resulting odds ratios to inform the profile of these so-called "Code Switchers," we might find that the . . . .
    ...
    - The odds of them being under 5'7" is about 5.21
    - The odds of them being Female is about 4.76
    - The odds of them being either a First- or Second-Year trainee is 2.71
    - The odds of them feeling disrepected by ES Staff and/or unconfident is 6.41
    - The odds of them feeling that they were *not* trained with sensitivity and adequate feedback is 3.17
    - The odds of them finding that nurses are not cooperative is 1.93
    - The odds of them having reported incidences of transient pain or injury is about 4.00
    - The odds of them being Non-White is 1.28 (although this result is the only one tested that is *not* statistically significant)
    
- (In the above logistic regression calculations the `F4.CODE.SWITCH` factor is the *response* variable (Factor 4 = 1, or "Yes"))
