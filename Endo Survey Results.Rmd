...
- If the Height Category is collapsed into two groups -- shorter than 5'7" and those how are 5'7" and above, there does appear to be some significance -- even if controlled separately for Training Level and Race.  Only controlling for Sex knocks this predictor out of sigificance, likely because the HEIGHT and SEX are so highly correlated.
