...
- **Conclusion:**  Ergonomic Optimization is a significant effect before and after adjust for Training Level, which itself is *not* a significant effect. (Beta for EO decreases from -0.108 to -0.104, meaning that as Ergo Optimization increases, it causes Transient Pain reports to decline.) 
...
- **Conclusion:**  Despite being correlated with First Year trainees, Sensitive Teacher is *not* a significant effect before (p=0.195) or after adjust for Training Level (p=0.149), which itself is *not* a significant effect. 
...
- **Conclusion:**  Sensitive Teacher is a highly significant effect before, and an extremely highly significant effect after adjusting for Training Level, which itself is an overall trend (almost significant, p=0.0596). (Beta for ST increases slightly from +0.191 to +0.204, meaning that as Teacher Sensitivity increases, reports of Ergonomic Optimization also rise.)  When compared to the reference category ("Advanced"), *ALL* other training levels are significantly different (i.e., lower).  Does this suggest that teachers are more likely to be sensitive to ergonomics in the Endoscopy Suite when dealing with older trainees, or does it suggest that younger trainees don't really know what proper ergonomics should entail and, therefore, how to rate their instructors on this metric?  (Does it take rising to the Advanced level before a trainee fully understands what constitutes "proper ergonomics?")
