...
- If we were to use the resulting odds ratios to inform the profile of these so-called "Code Switchers," we might find that the . . . .
    ...
    - The odds ratio for them being under 5'7" is about 5.21
    - The odds ratio for them being Female is about 4.76
    - The odds ratio for them being either a First- or Second-Year trainee is 2.71
    - The odds ratio for them feeling disrepected by ES Staff and/or unconfident is 6.41
    - The odds ratio for them feeling that they were *not* trained with sensitivity and adequate feedback is 3.17
    - The odds ratio for them finding that nurses are not cooperative is 1.93 
    - The odds ratio for them having reported incidences of transient pain or injury is about 4.00
    - The odds ratio for them using Dial Extenders is 1.83
    - The odds ratio for them being Non-White is 1.28 (insignificant results despite significant p-value - confint includes 1)
