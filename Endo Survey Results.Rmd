...
#### <span style="color:red"> [Click here for the latest version of the Summary Tables (downloadable Word document)](https://github.com/boskev/endogendersurvey/blob/main/Ergonomics%20Study%20Tables%207-5-22%20Full%20Cohort.docx)</span>
...
- <b>Final Takeaway:</b>  Training with Sensitivity + Respect from Sr. ES Staff + Cooperative Nurses + Lightweight Aprons signficiantlyreduce the likelihood of Pain relative to Sex, even after adjusting for Height and Training Level.
...
- This solution is very similar to the one above, except that it includes two questions that were originally ignored due to their perceived limited scope (i.e., questions regarding whether trainees were more or less likely to use Dial Extenders in front of a male or female instructor, as 70% of trainees reported not even using Dial Extenders).  With the addition of these two new questions, and by holiding the number of factors requested constant at nine factors, we noticed that the "Respect" and "Trainee Confidence" factors were "reunited" to form one solid, reliable factor (identical to what was observed in the previously discussed Varimax-rotated solutions).  It should be noted that the scoring of these questions included *all* subjects, not just those reporting having used Dial Extended -- so *every* respondent contributed in some way to the factor loadings and scores involving these new two questions.
- By including these two questions - and, more important, *all* subjects, even those who do not require Dial Extenders-  we may have stumbled upon an important factor that can be best described as `"Code Switching."`  While the term is typically used in the context of cultural linguistics, "Code Switching" here is meant to imply that some trainees may act one way in front of one audience (i.e., "their people") and another way in front of perceived figures of authority (or simply in front of instructors who are different from them).
- Another way of looking at this:  Code Switchers are "people pleasers" who are not inclined to "rock the boat."  And according to the correlation matrix above, they do not appear to command respect from ES Staff, do not perceive nurses as cooperative, are not vocal about ill-fitting lightweight or standard issue aprons, do not feel that they are trained with sensitivity/adequuate feedback (possibly because they do not insist on it), and as a result, they have high correlation with reported incidences of transient pain and injury.
...
```{r PLAYGROUND-CROSSWITCH,   fig.align='center', fig.dim= c(16,12)}
