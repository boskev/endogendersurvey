...
plot_xtab(SURVEY$TRAINING_LEVEL,SURVEY$EVER_INJURED,  margin = "row", 
 ...
 # How do First Years compare to everyone else? How does Advanced compare to everyone else?  
  ...
  a<- contrast(test.emmeans, list("Unadj OR: EVER_INJURED =Y on TRAINING_LEVEL = FirstYr vs. All" = c( 1, -1/2,  -1/2))) %>% tbl_df()
  b<- contrast(test.emmeans, list("Unadj OR: EVER_INJURED =Y on TRAINING_LEVEL = SecondYr vs. All" = c( -1/2, 1,  -1/2))) %>% tbl_df()
  c<- contrast(test.emmeans, list("Unadj OR: EVER_INJURED =Y on TRAINING_LEVEL = Advanced vs. All" = c( -1/2, -1/2,  1))) %>% tbl_df()
